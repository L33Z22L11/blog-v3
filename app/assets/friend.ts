...
function getAvatar(name: string, options?: Record<string, any>) {
    if (!options)
        options = { size: 96 }
...
export default <FriendGroup[]>[
    {
        ...
        items: [
            ...
            },
            {
                ...
                feed: 'https://www.bandao.ltd/feed',
                icon: 'https://www.bandao.ltd/wp-content/uploads/2021/11/symbol.png',
                avatar: 'https://www.bandao.ltd/wp-content/uploads/corepress_avatar/1.jpg',
            ...
            },
            {
                ...
                avatar: getAvatar('StudyingLover'),
            ...
            },
            {
                ...
                link: 'https://naive-blog.vercel.app/',
                feed: null,
                icon: 'https://naive-blog.vercel.app/favicon.ico',
                avatar: getAvatar('JiaHuann'),
            ...
            },
            {
                ...
                icon: getAvatar('ShawnJeffersonWang', { preset: 'icon' }),
                avatar: getAvatar('ShawnJeffersonWang'),
                archs: ['Hexo', 'Cloudflare'],
                date: '2024-06-13',
            ...
            },
            {
                ...
                feed: null,
                icon: getAvatar('fault123', { preset: 'icon' }),
                avatar: getAvatar('fault123'),
                archs: ['Hexo', 'Netlify'],
                date: '2024-07-29',
                comment: '大学同级，网安学习中。',
            },
            {
                ...
                feed: null,
                icon: getAvatar('Monoceros406', { preset: 'icon' }),
                avatar: getAvatar('Monoceros406'),
                archs: ['Hexo', 'GitHub Pages'],
                date: '2024-07-29',
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                icon: getAvatar('chiyuki0325', { preset: 'icon' }),
            ...
            },
            {
                ...
                feed: null,
                icon: getAvatar('maomao1996', { preset: 'icon' }),
                avatar: getAvatar('maomao1996'),
            ...
            },
            {
                ...
                feed: 'https://www.naokuo.top/rss2.xml',
                icon: 'https://www.naokuo.top/favicon.ico',
                avatar: 'https://www.naokuo.top/img/author/author_512.webp',
                archs: ['Hexo', 'Netlify'],
                date: '2024-02-18',
                comment: '折腾博客。',
            },
            ...
            },
            {
                ...
                feed: 'https://blog.yaria.top/feed.xml',
                icon: 'https://blog.yaria.top/favicon.ico',
                avatar: 'https://weavatar.com/avatar/795ce413eb6c7485954b78283ffa3e00?s=160',
            ...
            },
            {
                ...
                feed: 'https://dengqn.com/favicon.ico',
            ...
            },
            {
                ...
                icon: getAvatar('tinsir888', { preset: 'icon' }),
                avatar: getAvatar('tinsir888'),
                archs: ['Hexo', 'GitHub Pages'],
                date: '2024-10-18',
                comment: '计算机科学，留学生活。',
            },
