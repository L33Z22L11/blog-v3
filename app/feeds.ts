	...
	// #region Clarity
	{
		...
		entries: [
			myFeed,
			{
				...
				avatar: 'https://cdn.libravatar.org/avatar/646331bff8f19a0e05679c3cc0fc54d6',
				archs: ['Nuxt', 'Netlify'],
				date: '2023-12-23',
			...
			},
			{
				author: 'Noospic',
				desc: '星露谷农民',
				link: 'https://noospic.github.io/',
				feed: 'https://noospic.github.io/atom.xml',
				icon: 'https://noospic.github.io/noospic.jpeg',
				avatar: 'https://noospic.github.io/noospic.jpeg',
				archs: ['Nuxt', 'GitHub Pages'],
				date: '2026-09-06',
				comment: 'Clarity 主题魔改，记录 Vibe Coding、Agent 工具实践、生活随笔与番剧。',
			},
		],
	},
	// #endregion
	// #region 网上邻居 since 2024
	{
		...
		entries: [
			...
			},
			{
				...
				avatar: 'https://cravatar.cn/avatar/57ff1222a81493a0e72782530e77b269',
				archs: ['Hexo', 'Vercel'],
				date: '2024-06-16',
				comment: '虚构文学。',
			},
			...
			},
			{
				...
				avatar: 'https://weavatar.com/avatar/1dc444f85a6673099a47170588bbc6d7',
				archs: ['HTML', '服务器'],
				date: '2025-02-12',
				comment: '日常、前端、福瑞。',
			},
			...
			},
			{
				...
				title: 'Allen@冰轮韵',
				desc: '冰轮舞韵，代码凝魂。',
				link: 'https://lunarithm.space/',
				feed: 'https://lunarithm.space/index.xml',
				icon: 'https://lunarithm.space/favicon.ico',
				avatar: 'https://lunarithm.space/avatar.jpg',
				archs: ['Hugo', 'GitHub Pages'],
				date: '2026-08-12',
				comment: 'Arch Linux / i3wm 折腾、算法题解与东方同人随笔；使用 risotto 主题、giscus 评论。',
			},
			{
				author: 'Sanmu',
				title: 'Sanmussh Blog',
				desc: '一个喜欢二次元的博主日常记录',
				link: 'https://blog.movcloud.xyz/',
				feed: 'https://blog.movcloud.xyz/rss.xml',
				icon: 'https://blog.movcloud.xyz/favicon/firefly-32.png',
				avatar: 'https://blog.movcloud.xyz/logo.jpg',
				archs: ['Astro', 'Cloudflare'],
				date: '2026-08-30',
				comment: '使用 Firefly 主题，记录云服务器、网络调优、开发排障与二次元日常。',
			},
			{
				author: 'CAT',
				sitenick: '字节星球',
				title: '字节星球',
				desc: 'Code with Passion!',
				link: 'https://www.bytecho.net/',
				feed: 'https://www.bytecho.net/feed.xml',
				icon: 'https://www.bytecho.net/api/v1/uploads/file/6ff0b5ddb23a4851b968978fa5db6761b7610425.png',
				avatar: 'https://www.bytecho.net/api/v1/uploads/file/6ff0b5ddb23a4851b968978fa5db6761b7610425.png',
				archs: ['Nuxt', 'EdgeOne'],
				date: '2026-09-05',
				comment: '自建 Yuelai Engine 博客，分享 C++ / Go、算法、数据库与 DevOps 实践。',
			},
			{
				author: 'Kloudy',
				sitenick: 'Shape',
				...
				link: 'https://shape.kloudy.cn/',
				feed: 'https://shape.kloudy.cn/feed',
				icon: 'https://shape.kloudy.cn/static/img/icon.svg',
				avatar: 'https://cravatar.cn/avatar/2267b3aa6d17151f59a91b636fa5a52a',
				archs: ['Vue', '服务器'],
				date: '2026-09-14',
				comment: '很早直接关注的博主，但在公司发现马上变成前同事。',
			},
			/* ========从此处新增友链======== */
		],
	},
	...
	// #region 知识分享
	{
		...
		entries: [
			...
			},
			{
				...
				title: '猿客随笔',
				desc: '一个热爱探索的开发者',
				link: 'https://monkeyke.com/',
				feed: 'https://monkeyke.com/index.xml',
				icon: 'https://monkeyke.com/favicon.svg',
				avatar: 'https://cravatar.cn/avatar/dee014ecea51d0dc08dbb1aaec046b47',
				archs: ['Hugo', 'EdgeOne'],
				date: '2026-08-31',
				comment: '后端开发、工具选型与建站踩坑笔记，兼有旅行和生活记录。',
			},
		],
	},
	// #endregion
