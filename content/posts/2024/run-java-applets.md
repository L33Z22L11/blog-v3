...
- 2022年秋《高级语言程序设计 (C)》
  ...
  - 学校编写的教材使用了大量的非标准写法 `void main()`，这种不标准的写法在2000年代初逐渐废弃
- 2024年春《面向对象与 C++ 程序设计》
  - 课程使用谭浩强的《C++ 程序设计（第4版）》
...
当我听到别人讲述这些事情时，我只感到幸灾乐祸，但当这一切发生在自己身上时，我便无话可说了。
...
说干就干，我很快完成了 `HelloWorld` 任务，但是我在 Java Applet 代码瞥见弃用提示，便瞬间不淡定了。
...
如果只是运行 Java Applet，可以下载 [Java 8 运行环境 `jre-8u4xxx`](https://www.java.com/zh-CN/download/)。
...
当然，你可以通过清华大学开源软件镜像站下载 Adoptium OpenJDK 8。
